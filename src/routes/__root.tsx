...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "MLG Autohaus — Premium Used Cars" },
      { property: "og:description", content: "Hand-picked premium used cars, fully inspected and ready to drive away." },
